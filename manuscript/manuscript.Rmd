...
Functional traits are phenotypic characteristics that are related to the fitness and performance of an organism [@mcgill06d; @violle07] and have been used to describe the role of species in ecosystems [@fontaine05] or their ability to persist under certain environmental conditions (@refs).
...
Most prominently, plant traits from many different sources  have been collated into the quickly growing TRY database [@kattge11; e.g. including the extensive LEDA traitbase for the Northwest-European flora, @kleyer08].  Other more specialised databases for plant traits exist, for instance flower traits [BiolFlor for German wild flowers, @klotz02] and or root measurements [Fine-root Ecology Database; @iversen17]. Traits on crop plants have been collected in agronomy databases like Planteome and BetyDB [https://www.betydb.org/; @lebauer17]. Trait-data for lower plants are less completely assessed. <!-- TRY collates trait data from other published databases with individually owned datasets, provides an extended access management, data query services and tracking of data usage in studies and secondary publications. The great achievement of TRY is to harmonize these data into a unified scheme and provide a single platform of global coverage, which takes a huge effort to attract data submissions and map them into a common scheme. Repeating this exercise for other organism -->
...
Some data-types may benefit from existing global identifiers for occurrence data, e.g. a GBIF URI or a museum collection code referencing the precise specimen at which the measuremetn was taken and that is publicly available.
