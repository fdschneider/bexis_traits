...
To this end, trait data have been standardized in centralized databases for specific organism groups and regional scope, often centered around specific research questions [e.g. TRY, @kattge11; PanTHERIA, @jones09; AmphiBio, @oliveira17]. 
These compiled data are either being published as static data tables that are the product of a one-time effort of collecting and harmonizing data (in the case of AmphiBIO), or in the form of sophisticated online portals, which attract data submissions from a focal community of researchers and provide research networks for consensus building in data resolution and measurement methods [e.g. TRY, @kattge11]. Furthermore, these portals map heterogeneous data into a common scheme, and importantly also, offer access control and data usage policies, to protect the rights of the original data providers, while simplifying data queries for synthesis researchers who seek to utilize these often-complex datasets. 
...
# 1. A review of initiatives for trait-data standardisation
...
* the third aim at the standardization and develops consensus methods and definitions for traits and provides standard terminologies and 'ontologies'; 
* the fourth kind of initiative feed the needs of biodiversity informatics and develop relational database structures and provide platforms to relate trait data to a wider 'semantic web' of biodiversity data. 
