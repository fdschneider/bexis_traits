...
Functional traits are phenotypic characteristics that are related to the fitness and performance of an organism [@mcgill06; @violle07]. Because trait-based approaches to ecological and evolutionary research questions allow for both mechanistic insight (refs) and generality (refs) recent years have seen a proliferation of trait-based research in a wide range of fields.
