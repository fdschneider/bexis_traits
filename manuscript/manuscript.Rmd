...
<!--Malte: I guess, you mean their behaviour has not been observed, i.e. might know what they look like (what traits they have) because we caught / found individuals, but we have no idea what they do, where / how they live, with whom they interact etc. How about "... are yet undescribed and their behaviour, their interactions with other organisms and the environment and their ecological function are virtually unknown."-->
...
<!--Malte: It is not only CWM's and variance of traits, but also functional diversity metrics that are commonly used to understand change sin functional composition. I would probably add that here.-->
...
<!--Malte: First sentence, 'comparison across trophic levels". Not sure if this is the ideal wording; is it really comparisons that they allow for here? What about "Functional traits furthermore are an important tool for studying interactions across trophic levels." -->

Traits link ecological research to evolution, management (functions and services) for biodiversity conservation (land use intensification), and climate research (environmental filters). As such, a global synthesis of traits would offer major insights in ecosystem processes and enable projections in future climate and land use scenarios. 
...
Despite the obvious benefit of such global trait synthesis, an integration of several studies across taxa, trophic levels, or organisational scales remains difficult because of different organismal, methodological, and functional focus. A harmonization of trait data standards would be of huge benefit for the advancement of trait-based research and enable efficient data use for future generations. 
...
Summarize different questions, currently proposed in above- and belowground work within the Exploratories, focus on plant traits, arthropod traits, microbial traits.
...
Trait data have already been standardised into centralised databases for specific organism groups and research questions. Most prominently, plant traits from many different sources --including the extensive LEDA traitbase for the Northwest-European flora [@kleyer08]-- have been collated into the quickly growing TRY database [@kattge11]. TRY collates trait data from other published databases with individually owned datasets, provides an extended access management, data query services and tracking of data usage in studies and secondary publications. Other more specialised databases for plant traits exist, for instance flower traits [BiolFlor for German wild flowers, @klotz02] or root measurements [Fine-root Ecology Database; @iversen17]. The great achievement of TRY is to harmonize these data into a unified scheme and provide a single platform of global coverage, which takes a huge effort to attract data submissions and map them into a common scheme. Repeating this exercise for other organism groups or other trait-based research questions would be desirable.
...
In the animal kingdom, specialised trait-databases have been created that cover different organism groups, interaction types, or ecosystems. For instance, The BETSI database collects traits on soil invertebrates (http://betsi.cesab.org/). 
...
<!-- Malte: Shouldn't this be cbind() ? These functions do not add additional rows but additional columns, right?-->
