...
dt <- subset(gg, select = c(datasetName, type, DOI, NumberTaxa, NumberTraits, Responsible, CiteAs, TermsOfUse))

kable(dt, longtable=TRUE, 
      caption = "List of published trait datasets and databases", 
      booktabs = T) %>%
