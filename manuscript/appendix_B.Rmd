...
subtitle: "Towards an Ecological Trait-data Standard - Supplementary Material B"
author:
...
- **State terms of use!** To enable re-use, the metadata must contain the name of the author or owner of the data, the suggested citation for the data, as well as the license model or terms of use of the data. Ideally, these statements are provided by the data-hoster in a machine-readable way. 
...
kable_styling(latex_options = c("scale_down", "repeat_header", "striped"), font_size = 5)
...
kable(mothsStd[1:35,select_cols], longtable=TRUE, escape = TRUE, row.names = FALSE,
      booktabs = T, caption = caption) %>%
kable_styling(latex_options = c("scale_down", "repeat_header", "striped"), font_size = 5)
...
kable(heteroptera_raw[1:35,select_cols], longtable=TRUE, escape = TRUE, row.names = FALSE,
      booktabs = T, caption = caption) %>%
kable_styling(latex_options = c("scale_down", "repeat_header", "striped"), font_size = 5)
...
kable(heteroptera_long[heteroptera_long$traitName %in% c("Body_length", "Body_width", "Body_height", "Thorax_width"),select_cols][30:65,], longtable=TRUE, escape = TRUE, row.names = FALSE,
      booktabs = T, caption = caption) %>%
kable_styling(latex_options = c("scale_down", "repeat_header", "striped"), font_size = 5)
