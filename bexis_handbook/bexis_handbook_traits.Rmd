...
- The `BiodiversityExploratories` extension provides terms to relate the trait measurement to plots and sites in the exploratories framework, including `ExploratoriesPlotID`, `Exploratory` and `ExploType`
...
When saving your data, it is recommended to use 
